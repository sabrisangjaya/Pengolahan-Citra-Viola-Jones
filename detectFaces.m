...
function [faces,faceBound] = detectFaces(img,faceNum)
...
load 'trainedClassifiers.mat' % 286 classifiers
...
hold off;
fullpath=strcat('hasildeteksi (',int2str(faceNum),').jpg')
saveas(h,fullpath)
